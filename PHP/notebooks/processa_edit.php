<?php 
    ...
    $result_cursos = "UPDATE notebooks SET nome='$nome', patrimonio='$patrimonio', marca='$marca', modelo='$modelo', office='$office', usuario='$usuario', local='$local', departamento='$departamento', Date='$dateP' WHERE id = '$id'";
