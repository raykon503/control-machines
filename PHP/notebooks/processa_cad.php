<?php
	...
	$result_cursos = "INSERT INTO notebooks (nome, patrimonio, marca, modelo, office, usuario, local, departamento, Date) VALUES ('$nome', '$patrimonio', '$marca', '$modelo', '$office', '$usuario', '$local', '$departamento', '$dateP')";
